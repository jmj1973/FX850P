...
namespace FX850P.Blazor.Blazor
{
    public class Program
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            ...
            return Host.CreateDefaultBuilder(args)
                        ...
                        {
                            options.ServiceName = hostingOptions.ServiceName;
                        })
        ...
        private static void ConfigureKestrel(KestrelServerOptions options, HostingOptions hostingOptions)
        {
            ...
            {
                var certificateLocation = Path.Combine(GetContentRoot(), hostingOptions.SSLCertificateName);
                var certificate = new X509Certificate2(certificateLocation, hostingOptions.SSLCertificatePassword);
                ...
                options.Listen(IPAddress.Any, hostingOptions.SslPort.Value, listenOptions =>
                {
        ...
        static HostingOptions GetHostingOptions(string[] args)
        {
